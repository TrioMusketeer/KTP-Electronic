...
public class EKTPEnkapsulasi implements Comparable<EKTPEnkapsulasi>{
    private String  NIK;
    private String Nama;
    private String TTL;
    private String JK;
    ...
    public EKTPEnkapsulasi(String NIK, String Nama, String TTL, String JK, int Rt, int Rw, String Desa, String Kel, 
    ...
    @Override
    public int compareTo(EKTPEnkapsulasi b) {
        if(NIK.compareTo(b.getNIK()) < 0 ) return -1; 
